	...
	<form action="addressPaymentForOrderAction.jsp" method="post">
		...
		<div class="left-div">
			...
			<select class="input-style" name="paymentMethod">
				<option value="Cash on delivery (COD)">Cash on delivery
					(COD)</option>
		...
		<div class="right-div">
			<h3>Pay online on this Mynirmaan@oksbi</h3>
			<input class="input-style" type="text" name="trnsactionId"
		...
		<div class="right-div">
			...
			<button class="button" type="submit">
				Procced to Generate Bill and Save <i
