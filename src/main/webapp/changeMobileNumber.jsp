...
<body>
	...
	if ("done".equals(msg)) {
	%>
	<h3 class="alert" style="color: green;">Your Mobile Number
	...
	<form action="changeMobileNumberAction.jsp" method="post">
		<h3 style="color: black;">Enter Your New Mobile Number</h3>
		<input class="input-style" type="text" name="newMobileNo"
			placeholder="Enter Your New Mobile Number" required>
		<hr>
		<h3 style="color: black;">Enter Password (For Security)</h3>
